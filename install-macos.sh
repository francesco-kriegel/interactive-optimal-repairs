...
curl -L https://github.com/francesco-kriegel/interactive-optimal-repairs/releases/download/v0.1.3/interactive-optimal-repairs-0.1.3.jar --output Protege-5.6.3/plugins/interactive-optimal-repairs-0.1.3.jar
